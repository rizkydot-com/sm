// Create floating particles
        ...
        setTimeout(() => {
            setInterval(rotateText, 4500); // Change every 5 seconds
        }, 3500);
...
const locations = [
  { name: "Alun-Alun Bandung", coords: [-6.9218, 107.6079] },
  { name: "Gedung Sate", coords: [-6.9025, 107.6187] },
  { name: "Trans Studio Bandung", coords: [-6.9254, 107.6366] },
  { name: "Braga Street", coords: [-6.9171, 107.6098] }
];
...
const neon = document.querySelector('.about-graphic');
